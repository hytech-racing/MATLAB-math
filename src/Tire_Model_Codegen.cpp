...
// C/C++ source code generated on : Tue Oct 15 03:47:34 2024
//
...
void Tire_Model_Codegen::step()
{
  ...
  if (Saturation != 0.0) {
    ...
    if (Tire_Model_Codegen_U.FL != 0.0) {
      ...
      Tire_Model_Codegen_Y.Perceived_Vx = 0.6 * Saturation;
    } else {
      // Switch: '<Root>/Switch1' incorporates:
      //   Constant: '<S6>/Constant7'

      Tire_Model_Codegen_Y.Perceived_Vx = 0.0;
    }
  ...
  Tire_Model_Codegen_Y.MZFL = -Tire_Model_Codegen_Y.Perceived_Vx;
  ...
  Tire_Model_Codegen_Y.MZFR = -Tire_Model_Codegen_Y.Perceived_Vx;
  ...
  Tire_Model_Codegen_Y.MZRL = -Tire_Model_Codegen_Y.Perceived_Vx;
  ...
  Tire_Model_Codegen_Y.MZRR = -Tire_Model_Codegen_Y.Perceived_Vx;
